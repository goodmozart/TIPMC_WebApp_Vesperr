...
namespace TPMC_WebApp_Vesperr.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult RegisterNew(string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            return View();
        }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        memberModel.Email = model.Email;
                        if(model.EmpNumber == null)
                        {
                            memberModel.EmpNumber = "00000000";
                        }
                        else
                        {
                            memberModel.EmpNumber = model.EmpNumber;
                        }
                        memberModel.Name = model.FirstName + " " + model.LastName;
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RegisterNew(RegisterViewModel model, string returnUrl = null)
        //public async Task<IActionResult> RegisterNew([Bind("MemberId,EmpNumber,FirstName,LastName,Name")] RegisterViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
