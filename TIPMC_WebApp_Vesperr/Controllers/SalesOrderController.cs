...
namespace TIPMC_WebApp_Vesperr.Controllers
{
    public class SalesOrderController : Controller
    {
        ...
        {
            var applicationDbContext = _context.SalesOrder.Include(s => s.Member);
        ...
        public async Task<IActionResult> Create([Bind("SalesOrderId,Number,Description,SalesOrderDate,MemberId")] SalesOrder salesOrder)
        {
            ...
            ViewData["MemberId"] = new SelectList(_context.Member, "MemberId", "Name", salesOrder.MemberId);
            return View(salesOrder);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("SalesOrderId,Number,Description,SalesOrderDate,MemberId")] SalesOrder salesOrder)
        {
